...
- **System One** is a micro-MLP (5k–22k parameters, He initialization [18], trained with Adam [17]).
  It proposes a move with a confidence. For continuous control (racing, quadruped) it is a deep ensemble of
  five small regressors [22], whose disagreement sets the confidence.
